...
with tf.Session() as session:
    ...
    # Print out the perdiction for sanity check, may need to disalbe in
    # production
    for (truth, predicted_data) in zip(test_data_df[target].values, Y_predicted):
        print("The actual {} is {}, predicted to be {}".format(target, truth, predicted_data))
